...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">New Travel Request</h3>
    ...
    <div class="card-body">
        <form action="{{ route('ess.travel.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" class="form-control" id="estimated_amount" name="estimated_amount" value="{{ old('estimated_amount') }}">
            </div>
            <div class="form-group">
            ...
            <a href="{{ route('ess.travel') }}" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
</div>
@endsection
